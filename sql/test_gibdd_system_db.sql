...
VALUES ('2005-06-06','2015-06-06','A',1,18),
       ...
       ('2005-03-02','2015-03-02','C',2,20),
       ('2005-04-04','2016-04-04','CD',4,21),
       ('2006-05-05','2016-05-05','BCDE',3,22),
...
INSERT INTO vehicle_registration_certificates (registration_number,registration_date,leave_date,vehicle_inspector_id,vehicle_id)
VALUES ('ОЛ 645 Р','2005-06-15',NULL,1,1),
       ('ЛО 878 А','2006-04-10',NULL,2,2),
       ('СЛ 719 М','2003-04-16','2008-08-05',4,3),
       ('СЛ 719 М','2008-08-12',NULL,3,3),
       ('ДЛ 870 П','2004-09-20',NULL,1,4),
       ('ЗИ 066 К','2007-04-05',NULL,4,5),
       ('НП 984 М','2008-10-10',NULL,2,6),
       ('ДУ 981 К','2011-12-06',NULL,3,7),
       ('УЛ 035 Н','2009-03-15','2012-02-05',2,8),
       ('УЛ 035 Н','2012-02-15',NULL,3,8),
       ('ПО 910 О','2004-08-08',NULL,4,9),
       ('ЛР 684 Е','2003-07-03',NULL,4,10),
       ('НР 980 А','2006-02-04',NULL,4,11),
       ('РТ 036 В','2000-09-03',NULL,2,12);
...
INSERT INTO protocols (date,violation_id,patrol_inspector_id,vehicle_id)
VALUES ('2012-01-03',3,1,1),
       ('2012-02-04',4,2,2),
       ('2012-02-28',2,3,4),
       ('2012-03-30',6,3,5),
       ('2012-03-06',7,5,6),
